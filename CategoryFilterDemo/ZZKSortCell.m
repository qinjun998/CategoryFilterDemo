...
@interface ZZKSortCell ()

@end

@implementation ZZKSortCell
...
{
    // 添加对勾
    self.markView.frame = CGRectMake(SCREEN_WIDTH - 11 - 25, 0, 11, 7);  //设置对勾的大小
    self.markView.image = [UIImage imageNamed:@"selected"];
...
//    self.markView.y = self.height/2;
    self.markView.centerY = self.height/2;
